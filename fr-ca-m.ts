...
export default {
  ...
  UsernameScreen: {
    ...
    "confirmTitle": "Définir %{input} comme nom d'utilisateur ?",
    "forbiddenStart": "Ne peut débuter par lnbc1, bc1, 1, ou 3 et ne peut pas être une adresse Bitcoin ou une Facture Lightning",
    "letterAndNumber": "Lettre minuscule uniquement, chiffreet sousligné (_) sont acceptés",
    "emailAddress": "Le nom d'usager ne peut pas être une adresse courriel",
  ...
  WelcomeFirstScreen: {
    ...
    before: "Avant Bitcoin, les gens devaient compter sur les banques ou sur des fournisseurs de cartes de crédit, pour dépenser, recevoir et envoyer de l'argent.",
    care: "Pourquoi devrais-je m'en soucier?",
    learn: "Je ne veux pas te harceler, mais il y a beaucoup plus à apprendre, à creuser...",
    learnToEarn: "Apprendre à gagner",
  },
  WelcomePhoneInputScreen: {
    header: "Entrez votre numéro de téléphone et nous vous enverrons un code d'accès par SMS.",
    headerVerify: "Vérifiez que vous êtes humain",
  ...
  common: {
    activateWallet: "Activez le portefeuille",
    amountRequired: "Un montant est recquis",
    back: "Retour",
    bank: "Retour",
    ...
    invoice: "Facture",
    language: "Langue",
    languagePreference: "Préférence langue",
    lastName: "Nom",
    later: "Plus tard",
    loggedOut: "Vous avez été déconnecté.",
    logout: "Déconnexion",
    minutes: "minutes",
    needWallet: "Validez votre numéro de téléphone pour ouvrir votre portefeuille",
    next: "Suivant",
    No: "Non",
    note: "Note",
    ...
    transactionsError: "Erreur chargement des transactions",
    tryAgain: "Essayer à nouveau",
    type: "Type",
    username: "Nom d'usager",
    usernameRequired: "Un nom d'usager est recquis",
    yes: "Oui",
  },
  errors: {
    ...
    tooManyRequestsPhoneCode: "Trop de requêtes. Veuillez patienter avant de demander un autre SMS.",
    network: {
  ...
  lnurl: {
    ...
    commentRequired: "Comment requiredCommentaires recquis",
